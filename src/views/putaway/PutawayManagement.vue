    ...
    <div class="widget p-6 bg-white dark:bg-gray-900 rounded-lg shadow-lg transition-all">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div>
          ...
          <select v-model="selectedGood" class="p-3 border rounded-lg w-full dark:bg-gray-700 dark:text-white">
        ...
        <div>
          ...
          <select v-model="selectedLocation" class="p-3 border rounded-lg w-full dark:bg-gray-700 dark:text-white">
