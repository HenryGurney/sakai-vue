<template>
    <div class="p-6 bg-white dark:bg-gray-800 rounded-lg shadow-md">
        ...
        <div class="mt-4 flex flex-wrap gap-4">
            <div>
                <label class="block text-gray-700 dark:text-gray-300">Select Warehouse:</label>
                <select 
                    v-model="selectedWarehouse" 
                    class="w-full max-w-sm p-2 border rounded-md dark:bg-gray-700 dark:text-white"
                >
            ...
            <div>
                <label class="block text-gray-700 dark:text-gray-300">Select Date Range:</label>
                <input 
                    type="date" 
                    v-model="startDate" 
                    class="p-2 border rounded-md dark:bg-gray-700 dark:text-white"
                />
        ...
        <div class="mt-6 grid grid-cols-2 md:grid-cols-4 gap-4">
            <div v-for="metric in warehouseMetrics" :key="metric.label" class="p-4 bg-gray-100 dark:bg-gray-700 rounded-md shadow text-center">
        ...
        <div class="mt-8">
            ...
            <table class="w-full mt-4 border-collapse border border-gray-300 dark:border-gray-600">
                ...
                <tbody>
                    <tr v-for="(activity, index) in recentActivity" :key="index" class="text-center hover:bg-gray-100 dark:hover:bg-gray-700">
