<template>
    <div class="widget p-6 bg-white dark:bg-gray-900 rounded-lg shadow-lg transition-all">
        ...
        <div class="mb-6 p-4 border rounded-lg bg-gray-100 dark:bg-gray-700">
        ...
        <div class="flex gap-4">
            <select v-model="selectedOrder" class="p-3 border rounded-lg w-1/2 dark:bg-gray-700 dark:text-white">
        ...
        <div v-if="robotStatus !== 'Idle'" class="mt-4 p-3 border rounded-lg bg-gray-100 dark:bg-gray-700">
        ...
        <!-- Order Details -->
        <div v-if="selectedOrder" class="mt-6 p-4 border rounded-lg bg-gray-100 dark:bg-gray-700">
