<template>
  <div class="widget p-6 bg-white dark:bg-surface-900 rounded-lg shadow-lg transition-all">
    ...
    <div class="grid grid-cols-2 gap-4">
      <div>
        ...
        <input 
          ...
          class="p-3 border rounded-lg w-full dark:bg-gray-800 dark:text-white"
        />
      </div>
      ...
      <div>
        ...
        <select v-model="newOrder.bin" class="p-3 border rounded-lg w-full dark:bg-gray-800 dark:text-white">
    ...
    <button 
      @click="addOrder"
      class="mt-4 px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-800 transition w-full"
    >
      Add Order
    </button>
    ...
    <div class="mt-6">
      ...
      <div v-if="orders.length" class="bg-white dark:bg-gray-800 p-4 rounded-lg shadow-lg overflow-x-auto">
        <table class="w-full border-collapse border border-gray-300 dark:border-gray-600">
          ...
          <tbody>
            <tr v-for="(order, index) in orders" :key="index" class="hover:bg-gray-100 dark:hover:bg-gray-800">
