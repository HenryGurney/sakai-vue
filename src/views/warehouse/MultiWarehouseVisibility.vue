    ...
    <div class="widget p-6 bg-white dark:bg-surface-900 rounded-lg shadow-lg transition-all">
      ...
      <div class="mb-6 flex flex-wrap gap-4">
        <input 
          ...
          class="p-3 border rounded-lg w-full md:w-1/3 dark:bg-surface-800 dark:text-white"
        />
        <select v-model="selectedWarehouse" class="p-3 border rounded-lg w-full md:w-1/3 dark:bg-surface-800 dark:text-white">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div v-for="warehouse in filteredWarehouses" :key="warehouse.id" 
             class="p-4 bg-gray-100 dark:bg-surface-800 rounded-lg shadow-lg">
      ...
      <div class="mt-6">
        ...
        <table class="w-full border-collapse border border-gray-300 dark:border-gray-600">
          ...
          <transition-group tag="tbody" name="fade-slide">
            <tr v-for="item in filteredInventory" :key="item.id" class="hover:bg-gray-100 dark:hover:bg-gray-800 text-center">
