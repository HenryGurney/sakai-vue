<template>
    <div class="warehouse-management p-6 bg-white dark:bg-surface-900 rounded-lg shadow-md">
        ...
        <!-- Warehouse Details -->
        <div v-if="warehouse" class="mt-6 bg-gray-100 dark:bg-surface-800 p-4 rounded-md shadow">
